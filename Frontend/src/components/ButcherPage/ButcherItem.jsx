...
const ButcherItemSelector = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <button onClick={handleSubmit} className="ml-4 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
        Submit
      </button>
      
      <div className="mt-6">
        {items.map((item, index) => (
          <div key={index} className="border p-4 mb-4 shadow-sm rounded bg-gray-100">
