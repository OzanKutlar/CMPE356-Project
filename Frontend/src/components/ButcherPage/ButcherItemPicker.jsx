...
const ButcherItemPicker = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const data = await Util.callBackend("getStock");
        setItems(data);
        setLoading(false);
      } catch (err) {
  ...
  return (
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-6 text-center">Your Stock</h1>
...
export default ButcherItemPicker;